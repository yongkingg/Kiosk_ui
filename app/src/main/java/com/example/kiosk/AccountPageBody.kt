...
class AccountPageBody: Fragment() {
    ...
    fun initEvent(view:View){
        ...
        signUpBtn!!.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().replace(R.id.mainlayout,SignUpPageBody()).commit()
        }
        var findIdBtn : Button? = view.findViewById<Button>(R.id.findId)
        findIdBtn!!.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().replace(R.id.mainlayout,FindIdPageBody()).commit()
        }
        var findPwBtn : Button? = view.findViewById<Button>(R.id.findPW)
        findPwBtn!!.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().replace(R.id.mainlayout,FindPwPageBody()).commit()
        }
    }
}
